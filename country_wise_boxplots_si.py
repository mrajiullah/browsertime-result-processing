...
sns.boxplot(x="Ops",y="rumSpeedIndex", hue="protocol",data=data[(data.Country=="IT")],
            order=["TIM (IT)",
                   "Vodafone (IT)", "Wind (IT)"],
...
sns.boxplot(x="Ops",y="rumSpeedIndex", hue="protocol",data=data[(data.Country=="ES")],
...
sns.boxplot(x="Ops",y="rumSpeedIndex", hue="protocol",data=data[(data.Country=="NO")],
...
sns.boxplot(x="Ops",y="rumSpeedIndex", hue="protocol",data=data[(data.Country=="SE")],
...
pyplot.savefig("country_wise_boxplots_si.pdf")
