...
data=result[result.browser=="Chrome"]
data['protocol'].replace(["HTTP1.1/TLS","HTTP2"],
                           ["H1s","H2"],inplace=True)
data["pageLoadTime"]=data["pageLoadTime"]/1000
...
sns.boxplot(x="Ops",y="pageLoadTime", hue="protocol",data=data[(data.Country=="IT")],
            order=["TIM (IT)",
                   "Vodafone (IT)", "Wind (IT)"],
...
sns.boxplot(x="Ops",y="pageLoadTime", hue="protocol",data=data[(data.Country=="ES")],
...
sns.boxplot(x="Ops",y="pageLoadTime", hue="protocol",data=data[(data.Country=="NO")],
...
sns.boxplot(x="Ops",y="pageLoadTime", hue="protocol",data=data[(data.Country=="SE")],
            order=["Telia (SE)", "Telenor (SE)", "Tre (SE)"],
            hue_order=["H1s","H2"],palette="muted",showfliers=False)
pyplot.xlabel("Operators")
ax4.set_ylabel('')    
...
pyplot.savefig("country_wise_boxplots_plt_chm.pdf")
